    ...
    def tipo_colaborador(self, dadosJson):
        ...
        if (dadosJson.status_code == 200):
            ...
            if ("Mecatrônica" in dadosJson['course']['name'] or "Manufatura Digital" in dadosJson['course']['name']):
                return ['ap', self.idCardColadorador, self.edvColadorador, self.nameColadorador]
        ...
        if (dadosJson.status_code == 200):
            ...
            if (dadosJson['type']['type'] == 'Meio Oficial'):
                return ['mo', self.idCardColadorador, self.edvColadorador, self.nameColadorador]

                print('user meio oficial')

            if (dadosJson['type']['type'] == 'AHK'):
                return ['ahk', self.idCardColadorador, self.edvColadorador, self.nameColadorador]
                print('user AHK')

            if (dadosJson['type']['type'] == 'Gestor'):
                return ['adm', self.idCardColadorador, self.edvColadorador, self.nameColadorador]
